			...
			<div class="col-md-offset-1 col-md-10 col-sm-12 products-box">
				<div class="col-md-12">
					...
					<div class="single-product-content">
						...
						the importance of your project, and understands the details surrounding each decision. That is
						why Case Supply represents only elite manufacturers of cabinetry, appliances and fixtures, with
						...
						three-dimensional perspectives, from field measurement to implementation. Case Supply even has a
						referral network.
						<br><br>
